...
public class Courses : HandlerBase
{
    ...
    public override async Task<ChatResponse> Handle()
    {
        ...
        try
        {
            ...
            lastMessage.Content = lastMessage.Content.Replace("/course ", "").Trim();
    ...
    private async Task<ChatResponse> GetScenario(ChatRequest r)
    {
        ...
        var request = new HttpRequestMessage(HttpMethod.Post, ApplicationDetails.GetWorkflowHost() + "/webhook/courses")
        {
        ...
        if (output != null) result.Message.Content = output;
